...
\end{equation}
Dwa tryby wykonania współdzielą semantykę jednej ścieżki kodu: tryb
\emph{surrogate} (binarne floaty niosące gradienty surogatowe do
$W_q,W_k,W_v$) oraz tryb \emph{bitwise} produkujący ściśle
boole'owo-całkowitoliczbowy graf --- boolean'ową maskę AND, dokładną
akumulację uint8/int16 --- mapujący się jeden-do-jeden na instrukcje
POPCOUNT/AC sprzętu neuromorficznego. W trybie bitwise po zakodowaniu wejścia
...
klamrowany co krok do $|{\Wfast}|\le w_{\max}$. Ponieważ aktualizacje są
