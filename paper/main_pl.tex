...
\section{Rachunek energii: SOPs vs.\ FLOPs}
Operacje synaptyczne skalują się z aktywnymi impulsami, a nie gęstością
tensorów:
\begin{equation}
...
Ściśle rozgraniczamy algorytmiczną liczbę operacji od fizycznej energii sprzętowej:
liczba SOPs stanowi dokładny rachunek matematyczny, podczas gdy zużycie energii
w dżulach zależy od konkretnej implementacji krzemowej (np. Intel Loihi~2 lub akceleratory POPCOUNT).
...
Implementacja egzekwuje swoje niezmienniki mechanicznie: 137 testów
jednostkowych asertuje binarność wyjść, dokładne układy $[T,B,C]$,
