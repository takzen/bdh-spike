...
\end{equation}
Adaptive threshold homeostasis combined with dual-weight plasticity stabilizes continual learning,
preventing severe degradation ($F = 0.317 \pm 0.076$ vs $F = 0.530 \pm 0.084$ without homeostasis).
